...
class RosRobotController(Node):
    def __init__(self, name):
        ...
        self._action_server = ActionServer(self, FollowJointTrajectory, '/jetarm_arm_controller/follow_joint_trajectory', self.execute_trajectory_callback)

        # 建立夾爪指令動作接口
        self._gripper_action_server = ActionServer(self, GripperCommand, '/jetarm_gripper_controller/gripper_cmd', self.execute_gripper_callback)

        # 建立關節狀態發布者
        self.joint_state_publisher = self.create_publisher(JointState, 'isaac/joint_states', QoSProfile(depth=10))
    ...
    def initialize_arm_position(self):
        ...
        # initial_positions = [[1, 500], [2, 500], [3, 500], [4, 500], [5, 500], [10, 2]]  # 關節初始位置
        #initial_positions = [[1, 500], [2, 750], [3, 200], [4, 150], [5, 500], [10, 2]]  # 關節init位置        
        #initial_positions = [[1, 500], [2, 750], [3, 100], [4, 100], [5, 500], [10, 2]]  # 關節init位置        
